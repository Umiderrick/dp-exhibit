...
public final class DigestEncoder {
	...
	public static String digestEncode(String algorithm, byte input[]) {
		...
		try {
			...
			logger.error("摘要编码错误。{}",algorithm, e.getMessage());
		}
		return null;
	}
	...
	public static String encodePassword(String username, String passwd) {
		byte []b = (username + ":" + passwd).getBytes(QString.UTF8);
		return digestEncode(ALGM_MD5, b);
	}
	
	public static void main(String []args){
		System.out.println(digestEncode(ALGM_MD5,"214324656:214324656".getBytes(QString.UTF8)));
		System.out.println(digestEncode(ALGM_SHA1,"214324656".getBytes(QString.UTF8)));
		System.out.println(encodePassword("aaa","bbb"));
	}
}
